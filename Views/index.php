...
<html
  ...
  <head>
    ...
    <title> IEES | Maria Auxiliadora </title>
        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
          ...
          <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4">
            ...
            <a href="<?php echo base_url; ?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">COBAZ-GDC</span>
            </a>
          </div>
          ...
          <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
              <li class="nav-item">
                <a class="nav-link fw-medium" aria-current="page" href="<?php echo base_url; ?>#landingHero">Inicio</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="<?php echo base_url; ?>#landingFeatures">Caracteristicas</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="<?php echo base_url; ?>#landingTeam">Grupo</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="<?php echo base_url; ?>#landingFAQ">Preguntas Frecuentes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link fw-medium" href="<?php echo base_url; ?>#landingContact">Contactenos</a>
              </li>
                  ...
                  <div class="row gy-4">
                    ...
                    <div class="col-lg-4 d-none d-lg-block">
                      <div class="bg-body nav-img-col p-2">
                        <img
                          src="<?php echo base_url; ?>assets/img/front-pages/misc/nav-item-col-img.png"
          ...
          <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <!-- navbar button: Start -->
            <li>
              <a href="<?php echo base_url; ?>Usuarios/login" class="btn btn-primary" target="_blank"
        ...
        <div id="landingHero" class="section-py landing-hero position-relative">
          <div class="container">
            <div class="hero-text-box text-center">
              <h2 class="text-primary hero-title display-6 fw-bold">Bienvenidos a Grupo de DESARROLLO DE CAPACITACIÓN </h2>
              <h2 class="hero-sub-title h6 mb-4 pb-1">
                En estos tiempos donde la Técnologia predomina no te sientas solo<br class="d-none d-lg-block" />
                SOMOS TU MEJOR OPCIÓN COBAZ-GDC.
              </h2>
              <div class="landing-hero-btn d-inline-block position-relative">
                <span class="hero-btn-item position-absolute d-none d-md-flex text-heading"
                  ...
                  <img
                    ...
                    class="scaleX-n1-rtl"
                /></span>
                <a href="#landingPricing" class="btn btn-primary btn-lg">Registrese para tener su acceso.</a>
              </div>
            </div>
      ...
      <section id="landingFeatures" class="section-py landing-features">
        <div class="container">
          <div class="text-center mb-3 pb-1">
            <span class="badge bg-label-success">Nuestros Servicios Caracterizados.</span>
          </div>
          <h3 class="text-center mb-1">
            <span class="section-title">Todo lo que necesitas</span> para comenzar tu próximo proyecto.
          </h3>
          <p class="text-center mb-3 mb-md-5 pb-3">
            No es sólo un conjunto de herramientas, el paquete incluye una aplicación conceptual lista para implementar.
          </p>
          <div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              ...
              <h5 class="mb-3">Equipos Técnologicos</h5>
              <p class="features-icon-description">
                Contamos con equipos de ultima generación y con licencias originales.
              </p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
              ...
              <h5 class="mb-3">Capacitaciones Continuas</h5>
              <p class="features-icon-description">
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              ...
              <h5 class="mb-3">Paquetes Completos</h5>
              <p class="features-icon-description">
                Inicie su proyecto rápidamente sin tener que eliminar funciones innecesarias.
              </p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
              ...
              <h5 class="mb-3">Soluciones Informáticas</h5>
              <p class="features-icon-description">
                Simplemente aplique nuestras soluciones informáticas y vea sus propios datos cargados en segundos.
              </p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
              ...
              <p class="features-icon-description">No importa si son dias feriados estamos para apoyarlos en su emprendimiento.</p>
            </div>
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="<?php echo base_url; ?>assets/img/front-pages/icons/keyboard.png" alt="google docs" />
              </div>
              <h5 class="mb-3">Documentación Clara</h5>
              <p class="features-icon-description">Le brindamos la documentación clara y precisa.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row align-items-center gx-0 gy-4 g-lg-5">
            <div class="col-md-6 col-lg-5 col-xl-3">
              <div class="mb-3 pb-1">
                <span class="badge bg-label-primary">Reseñas de nuestros clientes </span>
              </div>
      ...
      <div class="footer-top">
        <div class="container">
          <div class="row gx-0 gy-4 g-md-5">
            <div class="col-lg-5">
              <a href="<?php echo base_url; ?>" class="app-brand-link mb-4">
                <span class="app-brand-logo demo">
                  <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fill-rule="evenodd"
